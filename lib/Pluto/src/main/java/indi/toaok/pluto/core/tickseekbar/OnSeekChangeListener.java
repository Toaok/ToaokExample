...
public interface OnSeekChangeListener {
     ...
     *
     * @param seekParams the params info activity_about the seeking bar
     */
     ...
     */
    void onStartTrackingTouch(TickSeekBar seekBar);
     ...
     * @param seekBar The SeekBar in which the touch gesture began
     */
    void onStopTrackingTouch(TickSeekBar seekBar);
}