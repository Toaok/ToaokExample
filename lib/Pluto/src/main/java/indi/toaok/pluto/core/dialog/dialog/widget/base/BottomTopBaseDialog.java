package indi.toaok.pluto.core.dialog.dialog.widget.base;
...
public abstract class BottomTopBaseDialog<T extends BottomTopBaseDialog<T>> extends BaseDialog<T> {
    ...
    /** set duration for inner indi.toaok.pluto.core.dialog.animation of mAnimateView(设置animateView内置动画时长) */
    ...
    /** show dialog and mAnimateView with inner show indi.toaok.pluto.core.dialog.animation(设置dialog和animateView显示动画) */
    ...
    /** dimiss dialog and mAnimateView with inner dismiss indi.toaok.pluto.core.dialog.animation(设置dialog和animateView消失动画) */
