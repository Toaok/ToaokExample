...
public class WrapperView extends ViewGroup {
    ...
    void update(View item, View header, Drawable divider, int dividerHeight) {
        ...
        //only remove the current item if it is not the coustom_radio_button as the new item. this can happen if wrapping a recycled view
        if (this.mItem != item) {
        ...
        //coustom_radio_button logik as above but for the header
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mHeader != null) {
            ...
            mDivider.setBounds(l + dip2px(getContext(), 15), t, r, mDividerHeight);
